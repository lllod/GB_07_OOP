...
public class User {
    /*
    Класс User является родительским я классов Student и Teacher.
    Вместо него можно подставить классы-наследники, что соответствует принципу Барбаы Лисков.
    Кроме того, класс не зависит от Student и Teacher, что соответствует принципу инверсии зависимостей.
     */
